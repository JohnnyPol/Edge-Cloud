...
- Sends CIFAR-100 samples to EDGE /infer via msgpack
...
def main():
    ...
    ap.add_argument("--out_csv", default="../logs/results_cifar100.csv")
    ap.add_argument("--out_jsonl", default="../logs/client_requests_cifar100.jsonl")
    ...
    edge_infer_url = args.edge_url.rstrip("/") + "/infer/cifar100"
    ...
    if args.num_samples <= 0:
        print(f"[client] using FULL CIFAR-100 test set ({len(indices)} samples)")
    else:
